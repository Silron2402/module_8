...
Изображение: Михаил Колодочка. Пример работы **A*** в реализации для трёхмерного пространства
...
[Изображение](https://www.youtube.com/watch?app=desktop&v=X0nokJwoivQ)
