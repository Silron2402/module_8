...
Мы говорили о том, что существуют локальные и глобальные системы планирования, и рассмотрели некоторые из них. Для более детального знакомства с системами планирования маршрута рекомендуем ознакомиться с [теоретическим материалом](.docs/avoidance_guide.md).
